...
connectDB(); // Aquí se realiza la conexión a MongoDB
...
const swaggerOptions = {
  definition: {
    ...
    servers: [
      {
        url: "http://localhost:3000/api", // URL base para la API
      },
    ],
    components: {
      securitySchemes: {
...
// Ejemplo de uso en Postman: http://localhost:3000/api/payments/create_preference

// ** Configuración del Servidor **
// Obtiene el puerto desde las variables de entorno o usa el puerto 3000 como predeterminado
